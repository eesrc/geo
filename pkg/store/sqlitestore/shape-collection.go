...
func (s *sqliteStore) initShapeCollectionStatements() error {
	var err error
...
func (s *sqliteStore) CreateShapeCollection(shapeCollection *model.ShapeCollection, userID int64) (int64, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
	...
	r, err := tx.Stmt(s.shapeCollectionStatements.create).Exec(
...
func (s *sqliteStore) GetShapeCollection(shapeCollectionID int64) (*model.ShapeCollection, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) GetShapeCollectionByUserID(shapeCollectionID int64, userID int64) (*model.ShapeCollection, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) UpdateShapeCollection(shapeCollection *model.ShapeCollection, userID int64) error {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) DeleteShapeCollection(shapeCollectionID int64, userID int64) error {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) ListShapeCollections(offset int64, limit int64) ([]model.ShapeCollection, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) ListShapeCollectionsByTeamID(teamID int64, offset int64, limit int64) ([]model.ShapeCollection, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) ListShapeCollectionsByUserID(userID int64, offset int64, limit int64) ([]model.ShapeCollection, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
