...
func (s *sqliteStore) initTokenStatements() error {
	var err error
...
func (s *sqliteStore) CreateToken(token *model.Token) (string, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) UpdateToken(token *model.Token) error {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) GetToken(token string) (*model.Token, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) GetTokenByUserID(token string, userID int64) (*model.Token, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) DeleteToken(token string, userID int64) error {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) ListTokens(offset int64, limit int64) ([]model.Token, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) ListTokensByUserID(userID int64, offset int64, limit int64) ([]model.Token, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
