...
func (s *sqliteStore) initSubscriptionStatements() error {
	var err error
...
func (s *sqliteStore) CreateSubscription(subscription *model.Subscription, userID int64) (int64, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
	...
	r, err := tx.Stmt(s.subscriptionStatements.create).Exec(
		subscription.Name,
		subscription.TeamID,
...
func (s *sqliteStore) GetSubscription(subscriptionID int64) (*model.Subscription, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) GetSubscriptionByUserID(subscriptionID int64, userID int64) (*model.Subscription, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) UpdateSubscription(subscription *model.Subscription, userID int64) error {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) DeleteSubscription(subscriptionID int64, userID int64) error {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) ListSubscriptionsByCollectionID(collectionID int64, userID int64, offset int64, limit int64) ([]model.Subscription, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) ListSubscriptionsByTrackerID(trackerID int64, userID int64, offset int64, limit int64) ([]model.Subscription, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) ListSubscriptionsByShapeCollectionID(shapeCollectionID int64, userID int64, offset int64, limit int64) ([]model.Subscription, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) ListSubscriptions(offset int64, limit int64) ([]model.Subscription, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *sqliteStore) ListSubscriptionsByUserID(userID int64, offset int64, limit int64) ([]model.Subscription, error) {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func ensureAdminOfSubscriptionResources(s *sqliteStore, tx *sql.Tx, userID int64, subscription *model.Subscription) error {
