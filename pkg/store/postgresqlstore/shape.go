...
func (s *sqlStore) initShapeStatements() error {
	var err error
...
func (s *sqlStore) CreateShape(shape *model.Shape, userID int64) (int64, error) {
	tx, err := s.db.Begin()
	if err != nil {
	...
	row := tx.Stmt(s.shapeStatements.create).QueryRow(
...
func (s *sqlStore) CreateShapes(shapes []*model.Shape, userID int64) error {
	tx, err := s.db.Begin()
...
func (s *sqlStore) GetShape(shapeCollectionID, shapeID int64, includeGeoJSON bool) (*model.Shape, error) {
...
func (s *sqlStore) GetShapeByUserID(shapeCollectionID int64, shapeID int64, userID int64, includeGeoJSON bool) (*model.Shape, error) {
...
func (s *sqlStore) UpdateShape(shape *model.Shape, userID int64) error {
...
func (s *sqlStore) DeleteShape(shapeCollectionID, shapeID int64, userID int64) error {
...
func (s *sqlStore) ListShapes(includeGeoJSON bool, offset, limit int64) ([]model.Shape, error) {
...
func (s *sqlStore) ListShapesByShapeCollectionID(shapeCollectionID int64, includeGeoJSON bool, offset int64, limit int64) ([]model.Shape, error) {
...
func (s *sqlStore) ListShapesByShapeCollectionIDAndUserID(shapeCollectionID int64, userID int64, includeGeoJSON bool, offset int64, limit int64) ([]model.Shape, error) {
...
func (s *sqlStore) ReplaceShapesInShapeCollection(shapeCollectionID int64, userID int64, shapes []*model.Shape) error {
